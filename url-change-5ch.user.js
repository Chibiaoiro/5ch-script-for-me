...
(function() {
    ...
    function modifyUrls() {
        ...
        links.forEach(function(link) {
            ...
            if (currentUrl.includes("5ch.net")) {
                ...
                // 5ch.find.page
                if (currentUrl.includes("find.5ch.net") && !currentUrl.includes("read.cgi/c/")) {
                    var modifiedUrl = href.replace("/read.cgi/", "/read.cgi/c/");
                    link.setAttribute('href', modifiedUrl);
    ...
    // Call the modifyUrls function when the page finishes loading
    window.addEventListener('load', modifyUrls);
})();
